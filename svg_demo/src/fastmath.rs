...
//! a vertex, and a mesh triangle spans some fourteen pixels. A profile put
//! `atan2f` at a quarter of the frame, so the accuracy is worth trading.
...
fn atan_unit(x: f32) -> f32 {
    ...
    x * (0.999_777_3
        + x2 * (-0.332_623_47
            + x2 * (0.193_543_46
                + x2 * (-0.116_432_87 + x2 * (0.052_653_32 + x2 * -0.011_721_2)))))
}
...
mod test {
    ...
    /// vertex. At this bound a point on the rim of a shape a thousand pixels
